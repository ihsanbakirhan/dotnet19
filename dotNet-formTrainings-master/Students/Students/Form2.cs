...
namespace Students
{
    public partial class Form2 : Form
    {
        ...
        public Form2(LessonShow sender,Student student)
        {
            InitializeComponent();
            this.student = student;
            this.lessonShow = sender;
        }
        ...
        public void btLessons_Click(object sender, EventArgs e)
        {
            var lessonShow = new LessonShow(student);
            lessonShow.Show();
        }
    }
}
