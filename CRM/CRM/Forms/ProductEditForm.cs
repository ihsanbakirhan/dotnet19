...
namespace CRM
{
    public partial class ProductEditForm : Form
    {
        ...
        private void variantsDataGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var variant = new Variant(Convert.ToInt64(dr["ProductVariantId"]), dr["VariantName"].ToString(), Convert.ToDecimal(dr["UnitPrice"]), Convert.ToInt16(dr["Cost"]), Convert.ToInt16(dr["Stock"]));
        ...
        {
            VariantEditForm variantEdit = new VariantEditForm(user, product, null, this);
            variantEdit.Show();
        }
    }
}
